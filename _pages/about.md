...
My research interests include automated machine learning, neural architecture search, and evolutionary computation for smart education applications. I have authored/coauthored <b>50+ peer-reviewed papers</b>, with <b>30+ papers</b> published in prestigious IEEE Trans. (TNNLS, TEVC, TETCI, etc.) and top-tier conferences (NeurIPS, AAAI, IJCAI, KDD, SIGIR, etc.). My Google Scholar citations are auto-updated: <b><span id="gs-citedby">700+</span></b> citations with an <b>H-index of <span id="gs-hindex">16</span></b>. I have received the National Scholarship for Postgraduate (2019), multiple best paper/poster awards at top conferences, and the Postdoctoral Fellowship Program (Grade B) of the China Postdoctoral Science Foundation.
