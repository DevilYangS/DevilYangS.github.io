...
My research interests include automated machine learning, neural architecture search, and evolutionary computation for smart education applications. I have authored/coauthored <b>50+ peer-reviewed papers</b>, with <b>30+ papers</b> published in prestigious IEEE Trans. (TNNLS, TEVC, TETCI, etc.) and top-tier conferences (NeurIPS, AAAI, IJCAI, KDD, SIGIR, etc.). My Google Scholar citations are auto-updated via JS (see <a href='https://scholar.google.com/citations?user=arzbiNUAAAAJ'>Google Scholar</a> for live counts). I have received the National Scholarship for Postgraduate (2019), multiple best paper/poster awards at top conferences, and the Postdoctoral Fellowship Program (Grade B) of the China Postdoctoral Science Foundation.
